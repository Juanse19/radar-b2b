/**
 * Unit tests for lib/radar-v2/providers/openai.ts
 *
...
describe('openaiProvider — Responses API with web_search_preview', () => {
  let openaiProvider: typeof import('@/lib/radar-v2/providers/openai').openaiProvider;

  beforeEach(async () => {
    vi.clearAllMocks();
    process.env.OPENAI_API_KEY = 'sk-test-key';
    const mod = await import('@/lib/radar-v2/providers/openai');
