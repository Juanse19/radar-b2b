/**
 * Unit tests for lib/radar-v2/db-migrations.ts
 *
 * Tests cover:
...
// vi.resetModules() calls. That means re-importing @/lib/radar-v2/db-migrations
