/**
 * Unit tests for lib/radar-v2/providers/gemini.ts
 *
...
describe('geminiProvider — Google Search Grounding', () => {
  let geminiProvider: typeof import('@/lib/radar-v2/providers/gemini').geminiProvider;

  beforeEach(async () => {
    vi.clearAllMocks();
    process.env.GOOGLE_API_KEY = 'AIza-test-key';
    const mod = await import('@/lib/radar-v2/providers/gemini');
