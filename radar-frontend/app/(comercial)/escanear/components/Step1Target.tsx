...
export function Step1Target({ state, onChange }: Props) {
  // Single-line or multi-line selection stored as comma-separated string
  ...
  // Sub-líneas — only when exactly 1 line is selected
  ...
  // Render the same rich card grid as the previous landing screen.
  if (!lineIsSet) {
    return (
  ...
  // Derive a display label for the selected line
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Sub-línea chips — only when 1 line selected ── */}
