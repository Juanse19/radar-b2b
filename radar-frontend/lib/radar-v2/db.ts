...
import type { RadarV2Result, RadarV2Session, RadarV2ResultsFilter } from './types';
...
export async function getRadarV2Results(filter: RadarV2ResultsFilter): Promise<RadarV2Result[]> {
  const where: string[] = [];
