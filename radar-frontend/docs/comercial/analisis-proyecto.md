...
├── comercial/       ← NUEVO: Radar v2 (Claude) — este módulo
...
└── comercial/       ← NUEVO: tipos + db para Radar v2
...
Items agregados:
```typescript
{ href: '/comercial',      label: 'Radar v2',      icon: Zap },
